  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <a href="CatalogServlet?caid=${requestScope.catalogs.caid }&type=update" target="mainFrame" onFocus="this.blur()" class="add">编辑栏目</a>
	    </td>
	  </tr>
	  <tr>
	    ...
	    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <input type="text" name="" value="${requestScope.catalogs.caname }" class="text-word" disabled="disabled"><span id="uspan"></span>
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="" value="${requestScope.catalogs.canumber}" class="text-word" disabled="disabled">
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		    ...
		    <c:if test="${requestScope.catalogs.castate eq '1'}">
		        	<option value="1" selected="selected">&nbsp;&nbsp;启用</option>
		        	<option value="2" >&nbsp;&nbsp;未启用</option>
	        </c:if>
	        <c:if test="${requestScope.catalogs.castate eq '2'}">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input name="caid" value="${requestScope.catalogs.caid}" type="hidden">
