...
<html>
  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  <tr>
	    <td width="99%" align="left" valign="top">您的位置：用户管理&nbsp;&nbsp;>&nbsp;&nbsp;回收站</td>
	  </tr>
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      <tr>
	        ...
	        <td align="center" valign="middle" class="borderbottom">
	        	<a href="ManagerServlet?id=${p.managerid }&type=update" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
	  ...
	  <tr>
	  <c:set var="size" value="${fn:length(requestScope.managerList) mod requestScope.pagesize }"></c:set>
	  <fmt:formatNumber type="number" value="${(fn:length(requestScope.managerList)-fn:length(requestScope.managerList)%requestScope.pagesize) div requestScope.pagesize}" maxFractionDigits="0" var="pagecount" pattern="#"></fmt:formatNumber>
	  ...
	  <c:set var="pageup" value="${pagecount}"></c:set>
	    ...
	    <td align="left" valign="top" class="fenye">共${fn:length(requestScope.managerList)}条数据 ${requestScope.startpage }/${pagecount } 页&nbsp;&nbsp;<a href="ManagerServlet?type=rec&page=${1 }" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;<a href="ManagerServlet?type=rec&page=${pagedown }" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;<a href="ManagerServlet?type=rec&page=${pageup }" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;<a href="ManagerServlet?type=rec&page=${pagecount }" target="mainFrame" onFocus="this.blur()">尾页</a></td>
	  </tr>
	  <script type="text/javascript">
		function del(id){
			swal({
				...
				if (isConfirm === true) {
					window.location.href='ManagerServlet?type=del&id='+id;
					swal(
					  '删除成功',
					  '',
					  'success'
