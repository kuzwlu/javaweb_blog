  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <a href="ArticleServlet?type=article" target="mainFrame" onFocus="this.blur()" class="add">添加文章</a>
	    </td>
	  </tr>
	  <tr>
	    <td align="left" valign="top">
	    <form method="post" action="ArticleServlet?type=add" enctype="multipart/form-data">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="arnumber" value="${requestScope.arnumber }" class="text-word" readonly="readonly">
	        </td>
	        </tr>
	       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <script id="container" name="content" type="text/plain" style="width:700px;height:350px;"></script>
	        </td>
	      </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">发布者：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="aruser" value="${sessionScope.managername}" class="text-word" readonly="readonly">
	        </td>
	        </tr>
	       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="file" name="arimage" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg"/>
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
