...
<html>
  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <c:if test="${fn:length(requestScope.managerList) == 0}" >
	  <c:set var="pagelist" value="0"></c:set>
	  </c:if>
	    <td align="left" valign="top" class="fenye">共${fn:length(requestScope.managerList)}条数据 ${pagelist }/${pagecount } 页&nbsp;&nbsp;<a href="ManagerServlet?type=page&page=${1 }" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;<a href="ManagerServlet?type=page&page=${pagedown }" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;<a href="ManagerServlet?type=page&page=${pageup }" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;<a href="ManagerServlet?type=page&page=${pagecount }" target="mainFrame" onFocus="this.blur()">尾页</a></td>
	  </tr>
	  <script type="text/javascript">
		function del(id){
			swal({
				...
				if (isConfirm === true) {
					window.location.href='ManagerServlet?type=recycled&id='+id;
					swal(
					  '删除成功',
					  '',
					  'success'
