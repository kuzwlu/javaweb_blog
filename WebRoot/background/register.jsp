	...
	$(function(){
	    ...
	    <div class="Main" >
	        <ul>
	            ...
	            <li class="middle_C"><span class="btn" ><input name="" type="submit" value="注册" style="background-color: #5cb85c;border: 0;margin-top: 50px;border-radius: 5px;width: 100px;height: 30;" /></span>
	            <a href="background/login.jsp" style="margin-top: 65px;margin-left: 15px;position: absolute;color: #333333b5;text-decoration:none;">有账户？点击登录</a></li>
