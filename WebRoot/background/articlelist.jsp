  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
	  		<tr>
	  		  ...
	  		  <a href="ArticleServlet?type=article" target="mainFrame" onFocus="this.blur()" class="add">新增文章</a></td>
	  		</tr>
		</table>
	    </td>
	  </tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <c:forEach items="${requestScope.pageList}" var="p">
	        ...
	        <td align="center" valign="middle" class="borderbottom">
	        	...
	        	<a href="ArticleServlet?arnumber=${p.arnumber }&type=exnumber"  target="mainFrame" onFocus="this.blur()" class="add" />上移</a>
	        	<span class="gray">&nbsp;|&nbsp;</span>
	  ...
	  <c:set var="pagelist" value="0"></c:set>
	    ...
	    <td align="left" valign="top" class="fenye">共${fn:length(requestScope.articleList)}条数据 ${pagelist }/${pagecount } 页&nbsp;&nbsp;<a href="ArticleServlet?type=page&page=${1 }" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;<a href="ArticleServlet?type=page&page=${pagedown }" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;<a href="ArticleServlet?type=page&page=${pageup }" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;<a href="ArticleServlet?type=page&page=${pagecount }" target="mainFrame" onFocus="this.blur()">尾页</a></td>
	  </tr>
