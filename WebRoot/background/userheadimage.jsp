...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
  ...
  <body style="background-color: #efefef;">
		<center>
		<div style="margin-top: 110px;"><img alt="" src="${requestScope.image }" id="qq"/>
		</div>
		<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#avatar-modal" style="margin: 10px;">修改头像</button>
		<div style="text-align:center;font:normal 14px/24px 'MicroSoft YaHei';"><p>保存修改后，能立即看到效果哦！</p></div>
		</center>
		...
		//做个下简易的验证  大小 格式 
			...
			function imagesAjax(src) {
				...
				data.jid = $('#jid').val();
				$.ajax({
					url: "HeadImage?type=user",
					data: {"src":data.img,"id":userid},
					type: "POST",
					//dataType: 'json',
					success:function(re) {
						//console.log(src);
