  ...
  <script type="text/javascript">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <a href="ManagerServlet?id=${requestScope.managerAll.managerid }&type=update" target="mainFrame" onFocus="this.blur()" class="add">修改管理员</a>
	    </td>
	  </tr>
	  <tr>
	    <td align="left" valign="top">
	    <form method="post" action="ManagerServlet">
	    <input type="hidden" value="updata" name="type">
	    ...
	    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'" hidden="hidden">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">${requestScope.managerAll.managerid }</td>
	        </tr>
	    	<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">管理员名：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
			<input type="text" name="name" value="${requestScope.managerAll.managername }" class="text-word" disabled="disabled">
			</td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <select name="mstates" id="level">
	        	<c:if test="${requestScope.managerAll.matate eq '1'}">
		        	<option value="1" selected="selected">&nbsp;&nbsp;启用</option>
		        	<option value="2" >&nbsp;&nbsp;未启用</option>
		        	<option value="3" >&nbsp;&nbsp;删除</option>	
	        	</c:if>
		    	<c:if test="${requestScope.managerAll.matate eq '2'}">
		    	<option value="1" >&nbsp;&nbsp;启用</option>
	        	<option value="2" selected="selected">&nbsp;&nbsp;未启用</option>
	        	<option value="3" >&nbsp;&nbsp;删除</option>	
		    	</c:if>
		    	<c:if test="${requestScope.managerAll.matate eq '3'}">	      
		    	<option value="1" >&nbsp;&nbsp;启用</option>
	        	<option value="2" >&nbsp;&nbsp;未启用</option>
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input name="id" value="${requestScope.managerAll.managerid }" type="hidden">
